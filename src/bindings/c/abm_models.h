...
SHO_PUBLIC void initialise_abm(const char *model_type, int total_cells, int num_forces, double time_step, double min_time_step, int input_seed);
SHO_PUBLIC void finalise_abm(const char *model_type);
