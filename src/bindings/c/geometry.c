...
void define_1d_element_tree_c(const char *ELEMFILE, int *filename_len, int *anastomosis_elem_in);
void define_1d_element_c(const char *ELEMFILE, int *filename_len);
...
void define_1d_element_tree(const char *ELEMFILE,int anastomosis_elem_in)
{
  int filename_len = strlen(ELEMFILE);
  define_1d_element_tree_c(ELEMFILE, &filename_len, &anastomosis_elem_in);
}

void define_1d_element(const char *ELEMFILE)
{
  int filename_len = strlen(ELEMFILE);
  define_1d_element_c(ELEMFILE, &filename_len);
}
