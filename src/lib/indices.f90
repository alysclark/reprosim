...
!parameters
  ...
  integer ::num_ne,ne_radius,ne_length,ne_vol,&
       ...
       ne_radius_out,ne_group,ne_Qdot,ne_damk,ne_mu,&
       ne_dp
...
public num_ne,ne_radius,ne_length,ne_vol,&
      ...
      ne_group,ne_Qdot,ne_damk,ne_mu,ne_dp
...
!Interfaces
private
public perfusion_indices
public perfusion_transport_indices
public get_ne_radius
...
!
!> Perfusion indices
  subroutine perfusion_transport_indices
  ...
  !DEC$ ATTRIBUTES DLLEXPORT,ALIAS:"SO_PERFUSION_INDICES" :: PERFUSION_INDICES
    ...
    sub_name = 'perfusion_transport_indices'
    call enter_exit(sub_name,1)
    ...
    nu_blood_press=2
     ...
     call enter_exit(sub_name,2)
  end subroutine perfusion_transport_indices
