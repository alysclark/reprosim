...
! temporary, for debugging:
  ...
  public elem_field_fetal, num_elems_fetal, elem_nodes_fetal, node_xyz_fetal, nodes_fetal, elems_fetal, num_nodes_fetal,&
          node_field_fetal, elem_cnct_fetal,elem_direction_fetal,elems_at_node_fetal
